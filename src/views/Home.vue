      ...
      <el-col :span="4">
        ...
        >
          ...
          <el-submenu index="2">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="2-2" @click="addTab(editableTabsValue)"
                >技工租车辆</el-menu-item
              >
              <el-menu-item index="2-3" @click="addTab(editableTabsValue)"
                >技工组</el-menu-item
              >
            </el-menu-item-group>
          ...
          <el-submenu index="4">
            ...
            <el-menu-item-group>
              <el-menu-item index="4-1" @click="addTab(editableTabsValue)"
                >用户车辆</el-menu-item
              >
              <el-menu-item index="4-2" @click="addTab(editableTabsValue)"
                >会员管理</el-menu-item
              >
              <el-menu-item index="4-3" @click="addTab(editableTabsValue)"
                >用户列表</el-menu-item
              >
            </el-menu-item-group>
          ...
          <el-submenu index="5">
            ...
            <el-menu-item-group>
              <el-menu-item index="5-1" @click="addTab(editableTabsValue)"
                >系统日志</el-menu-item
              >
              <el-menu-item index="5-2" @click="addTab(editableTabsValue)"
                >角色附加</el-menu-item
              >
              <el-menu-item index="5-2" @click="addTab(editableTabsValue)"
                >权限附加</el-menu-item
              ...
              <el-menu-item index="5-2" @click="addTab(editableTabsValue)"
                >基础数据</el-menu-item
              >
              <el-menu-item index="5-3" @click="addTab(editableTabsValue)"
                >数据统计</el-menu-item
              >
            </el-menu-item-group>
          ...
          <el-menu-item index="10">
            <el-row>
              <el-button type="danger" round>退出系统</el-button>
            </el-row>
          </el-menu-item>
        </el-menu>
      </el-col>
